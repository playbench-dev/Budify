                                    ...
                                    return (
                                        <TouchableWithoutFeedback onPress={() => this._CheckDatas(obj.item)}>
                                            <View key={obj.index} style={{ flexDirection: 'row', height: 50, alignItems: 'center', }}>
                                                ...
                                                <Image source={this.state.selectedTextDatas.filter((el) => el.category_no == obj.item.category_no)[0] ? imgRadioOn : imgRadioOff} style={{ width: 16, height: 16, resizeMode: 'contain' }}></Image>
                                            </View>
